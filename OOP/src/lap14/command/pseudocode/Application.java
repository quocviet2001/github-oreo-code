...
public class Application {
    ...
    private Buttons copyButton;
    private Buttons cutButton;
    private Buttons pasteButton;
    private Buttons undoButton;
    ...
    public void createUI() {
        ...
        copyButton = new Buttons();
        cutButton = new Buttons();
        pasteButton = new Buttons();
        undoButton = new Buttons();
